...
DATABASE_URL = DATABASE_URL = "postgresql://hsop:Estv,123@localhost:5432/hospital_db"
...
def registrar_medico_teste():
    medico_teste = {
    "nome": "Estevao",
    "data_nascimento": datetime.strptime("2025-08-11", "%Y-%m-%d").date(),
    "cpf": "000.000.000-05",
    "email": "marisilva1006@gmail.com",
    "telefone": "85998343",
    "senha": "123",
    "cargo": "recepcionista",
